...
/*   Updated: 2024/12/01 00:35:25 by marvin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	solve_caps(t_vector pos, t_vector ray, t_figure *obj)
{
    ...
    // printf("center.x = %f center.y = %f center.z = %f\n", obj->cylinder->center1.x, obj->cylinder->center1.y ,obj->cylinder->center1.z);
	
    p.x1 = caps_intersection(pos, ray, obj->cylinder->orient, obj->cylinder->center);
	p.x2 = caps_intersection(pos, ray, obj->cylinder->orient, obj->cylinder->center1);
